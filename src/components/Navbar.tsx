  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 h-20 flex items-center justify-between gap-4">
        ...
        <a 
          href="#download"
          className="shrink-0 bg-islamic-green text-white hover:bg-islamic-green-hover px-4 sm:px-6 py-3 rounded-full font-bold uppercase tracking-widest text-xs inline-flex items-center gap-2 transition-all shadow-sm hover:shadow-md focus:outline-none focus-visible:ring-4 focus-visible:ring-islamic-gold/30"
        >
