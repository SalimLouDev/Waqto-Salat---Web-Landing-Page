  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 h-20 flex items-center justify-between gap-4">
        ...
        <a 
          href="#download"
          className="shrink-0 bg-islamic-gold/10 text-islamic-gold hover:bg-islamic-gold hover:text-white px-4 sm:px-6 py-3 rounded-full font-bold uppercase tracking-widest text-xs transition-all shadow-sm"
        >
          Download
        </a>
      </div>
